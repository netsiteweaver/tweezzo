jQuery(function(){
    ...
    $(".monitor").on("change", function(){
        ...
        let task_search_query = $('#task_search_query').val();

        Overlay("on");
        setTimeout(function(){
            window.location.href = '/tasks/listing?customer_id='+customer_id+"&project_id="+project_id+"&sprint_id="+sprint_id+"&stage="+stage+"&order_by="+order_by+"&order_dir="+order_dir+"&display="+display+"&assigned_to="+assigned_to+"&notes_only="+notes_only+"&search_text="+task_search_query;
        },100)
    })
    ...
    $('.applyChosenStages').on("click", function() {
        ...
        Overlay("on");
        setTimeout(function(){
            window.location.href = '/tasks/listing?customer_id='+customer_id+"&project_id="+project_id+"&sprint_id="+sprint_id+"&stage="+JSON.stringify(selectedStages)+"&order_by="+order_by+"&order_dir="+order_dir+"&display="+display+"&assigned_to="+assigned_to+"&notes_only="+notes_only+"&search_text="+task_search_query;
