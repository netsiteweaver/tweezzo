...
$billable_only = !empty($filters['billable_only']);
$rateVal = ($rate !== null) ? $rate : '';
?>
<form action="<?php echo base_url('reports/client'); ?>" method="get" class="no-print mb-3">
    <div class="row">
        <div class="col-md-2">
        ...
        <div class="col-md-2">
            ...
            <input class="form-control" type="number" step="0.01" min="0" name="rate" id="rate" value="<?php echo htmlspecialchars((string) $rateVal); ?>" required placeholder="e.g. 800">
        </div>
        <div class="col-md-1">
    ...
    <div class="row mt-2">
        ...
        <div class="col-md-2 mt-4">
            <div class="form-check">
                <input type="checkbox" class="form-check-input" name="billable_only" id="billable_only" value="1" <?php echo $billable_only ? 'checked' : ''; ?>>
                <label class="form-check-label" for="billable_only">Billable tasks only</label>
            </div>
        </div>
...
<form action="<?php echo base_url('reports/save'); ?>" method="post" class="no-print mb-3">
    ...
    <input type="hidden" name="billable_only" value="<?php echo $billable_only ? '1' : '0'; ?>">
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <input type="text" class="form-control" name="title" id="title" placeholder="e.g. ACME — June 2026 invoice">
        </div>
