...
<div class="row no-print">
    ...
    <div class="col-md-2">
        ...
        <div class="input-group mb-3">
            <input type="text" class="form-control task-listing-search" name="tasks_search_text" id="tasks_search_text" placeholder="Search in tasks..." aria-label="Search in tasks...e" aria-describedby="basic-addon2" value="<?php echo $this->input->get("search_text");?>">
