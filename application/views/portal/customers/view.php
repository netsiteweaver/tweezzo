			...
			<div class="card-body">
				<form id="task_notes" action="tasks/notes" method="POST">
					...
					<div class="form-group">
						...
						<textarea name="notes" id="" rows="5" class="summernote form-control" placeholder="Enter your notes. Other users will be able to view your notes." required></textarea>
					</div>
					<div class="form-group">
