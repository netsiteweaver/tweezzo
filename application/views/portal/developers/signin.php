...
<head>
    <meta charset="UTF-8">
    <title>Developer's Portal | Task Manager</title>
    <base href="<?php echo base_url();?>">
    <link rel='stylesheet' href='https://use.fontawesome.com/releases/v5.2.0/css/all.css'>
    <link rel='stylesheet' href='https://use.fontawesome.com/releases/v5.2.0/css/fontawesome.css'>
    <link rel="stylesheet" href="./assets/css/portal/developers/signin.css?t=<?php echo date('YmdHis');?>">
    <!-- AlertifyJS -->
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/png" href="/assets/favicon/developerPortal/favicon-96x96.png" sizes="96x96" />
    <link rel="icon" type="image/svg+xml" href="/assets/favicon/developerPortal/favicon.svg" />
    <link rel="shortcut icon" href="/assets/favicon/developerPortal/favicon.ico" />
    <link rel="apple-touch-icon" sizes="180x180" href="/assets/favicon/developerPortal/apple-touch-icon.png" />
    <link rel="manifest" href="/assets/favicon/developerPortal/site.webmanifest" />
...
<body>
        ...
        <div class="screen">
            <div class="screen__content">
                ...
                <form class="login" method="post">
                    <div class='header'>Developer's Portal</div>
    ...
    <script src="<?php echo base_url('assets/js/portal/developers/signin.js')."?".date("YmdHis"); ?>"></script>
